...
public class NextStreet {
    ...
    public NextStreet(double lat1, double lon1, double lat2, double lon2, Context context){
    ...
    public String findActualStreet(){
        ...
        try {
            ...
            if (!list.isEmpty()) {
                ...
                actualStreet = address.getAddressLine(0);
            }
