...
public class LocationSender  {
    ...
    private Thread tGetLocation = null;
                ...
                try {
                    ...
                    while (!isInterrupted()) {
                        ...
                        if(!town.equals("Buscando ciudad...")) {
                            final boolean tabletSize = CommandHandlerManager.getInstance().getMainActivity().getResources().getBoolean(ar.com.klee.marvinSimulator.R.bool.isTablet);
                                ...
                                public void run() {
                                    if(!wrongCoordinates) {
                                        ...
                                        if (actualTime != null && previousTime != null) {
                                            ...
                                            Log.d("GPS - Seconds:", seconds.toString());
                                        ...
                                        Log.d("GPS - Speed1:", speed1.toString());
                                        Log.d("GPS - Speed2:", speed2.toString());
        ...
        tGetLocation = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    File file = new File(sdcard,"tripPath.txt");
                    ...
                    while (!isInterrupted()) {
                        try {
                            if ((line = br.readLine()) != null) {
                                ...
                                handleNewLocation(Double.parseDouble(st.nextToken()), Double.parseDouble(st.nextToken()));
                            }
                        }
                        catch (IOException e) {
    ...
    private void handleNewLocation(double latitude, double longitude) {
        ...
        if(previousLatitude!=0.0) {
            ...
            if(polylineLength > 100.0) {
                Log.d("GPS","Error en coordenadas");
