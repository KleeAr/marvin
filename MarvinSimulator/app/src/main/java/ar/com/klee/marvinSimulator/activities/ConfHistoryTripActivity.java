...
public class ConfHistoryTripActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ar.com.klee.marvinSimulator.R.layout.activity_configure_history_trip);
        ...
        spinner2 = (Spinner) findViewById(ar.com.klee.marvinSimulator.R.id.spinner2);
