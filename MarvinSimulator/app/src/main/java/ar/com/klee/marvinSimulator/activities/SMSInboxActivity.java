...
import ar.com.klee.marvinSimulator.sms.InboxAdaptor;
import ar.com.klee.marvinSimulator.sms.Mensaje;
...
public class SMSInboxActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ar.com.klee.marvinSimulator.R.layout.activity_sms_inbox);

        Typeface fontBold = Typeface.createFromAsset(getAssets(),"Bariol_Bold.otf");
        TextView textView = (TextView) findViewById(ar.com.klee.marvinSimulator.R.id.textView);
        textView.setTypeface(fontBold);

        smsListView = (ListView) findViewById(ar.com.klee.marvinSimulator.R.id.SMSList);
        refreshSmsInbox();
    ...
    public void showCallDialog() {
        ...
        TextView notifiacion = (TextView) customDialog.findViewById(ar.com.klee.marvinSimulator.R.id.textView);
