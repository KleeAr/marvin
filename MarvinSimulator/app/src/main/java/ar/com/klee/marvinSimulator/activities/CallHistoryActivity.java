...
import ar.com.klee.marvinSimulator.call.Call;
import ar.com.klee.marvinSimulator.call.CallDriver;
import ar.com.klee.marvinSimulator.call.HistoryAdapter;
...
public class CallHistoryActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ar.com.klee.marvinSimulator.R.layout.activity_call_history);

        callListView = (ListView) findViewById(ar.com.klee.marvinSimulator.R.id.callListView);
        ...
        HistoryAdapter objAdapter = new HistoryAdapter(CallHistoryActivity.this, ar.com.klee.marvinSimulator.R.layout.item_call_history, callList);
    ...
    * Recibe como parametro el numero del item selecccionado
    ...
    public  void showCallDialog(){
        ...
        customDialog.setContentView(ar.com.klee.marvinSimulator.R.layout.dialog_inbox);
        ...
        TextView textFor = (TextView) customDialog.findViewById(ar.com.klee.marvinSimulator.R.id.responseHeader);
        ...
        customDialog.findViewById(ar.com.klee.marvinSimulator.R.id.responder).setOnClickListener(new View.OnClickListener() {
        ...
        customDialog.findViewById(ar.com.klee.marvinSimulator.R.id.llamar).setOnClickListener(new View.OnClickListener() {
