...
public class ListviewCategoriesAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if(convertView == null){
            convertView = mInflater.inflate(ar.com.klee.marvinSimulator.R.layout.configure_list_item, null);
            holder = new ViewHolder();
            holder.txtCategorie = (TextView) convertView.findViewById(ar.com.klee.marvinSimulator.R.id.label);
