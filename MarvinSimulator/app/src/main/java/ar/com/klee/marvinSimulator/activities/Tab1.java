...
public class Tab1 extends Fragment implements View.OnClickListener, View.OnLongClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(ar.com.klee.marvinSimulator.R.layout.tab_1, container, false);

        MainMenuFragment.shortcutButton[0] = (ImageButton) v.findViewById(ar.com.klee.marvinSimulator.R.id.imageButton1);
        MainMenuFragment.shortcutButton[1] = (ImageButton) v.findViewById(ar.com.klee.marvinSimulator.R.id.imageButton2);
        MainMenuFragment.shortcutButton[2] = (ImageButton) v.findViewById(ar.com.klee.marvinSimulator.R.id.imageButton3);
        MainMenuFragment.shortcutButton[3] = (ImageButton) v.findViewById(ar.com.klee.marvinSimulator.R.id.imageButton4);
        MainMenuFragment.shortcutButton[4] = (ImageButton) v.findViewById(ar.com.klee.marvinSimulator.R.id.imageButton5);
        MainMenuFragment.shortcutButton[5] = (ImageButton) v.findViewById(ar.com.klee.marvinSimulator.R.id.imageButton6);
