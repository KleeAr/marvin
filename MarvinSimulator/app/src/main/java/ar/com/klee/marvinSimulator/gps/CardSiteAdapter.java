...
public class CardSiteAdapter extends RecyclerView.Adapter<CardSiteAdapter.ViewHolder>  {
    ...
    public CardSiteAdapter(List<Site> mItems) {
        ...
        for(int i=0;i<mItems.size();i++) {
            ...
            if(site.getSiteThumbnail()==0)
                site.setSiteThumbnail(ar.com.klee.marvinSimulator.R.drawable.city);
        }
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(ar.com.klee.marvinSimulator.R.layout.site_recycler_view_item, viewGroup, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        if(site.getSiteThumbnail() == 0 || site.getSiteThumbnail() == ar.com.klee.marvinSimulator.R.drawable.city)
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            super(itemView);
            imgThumbnail = (ImageView)itemView.findViewById(ar.com.klee.marvinSimulator.R.id.img_thumbnail);
            tvSite = (TextView)itemView.findViewById(ar.com.klee.marvinSimulator.R.id.tv_site);
