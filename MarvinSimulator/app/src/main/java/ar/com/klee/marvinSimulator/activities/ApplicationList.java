...
import ar.com.klee.marvinSimulator.applications.ApplicationAdapter;
...
public class ApplicationList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ar.com.klee.marvinSimulator.R.layout.activity_application_list);
    ...
    public void getInstalledAppList(final int buttonClick) {
        ...
        ListView listview = (ListView) findViewById(ar.com.klee.marvinSimulator.R.id.listView);
