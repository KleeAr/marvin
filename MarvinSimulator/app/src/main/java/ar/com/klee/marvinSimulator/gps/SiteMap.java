...
public class SiteMap extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(ar.com.klee.marvinSimulator.R.layout.activity_site, container, false);
        mMapView = (MapView) v.findViewById(ar.com.klee.marvinSimulator.R.id.siteMap);
