...
import ar.com.klee.marvinSimulator.Command;
import ar.com.klee.marvinSimulator.activities.ExpandableListAdapter;
...
public class VozFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(ar.com.klee.marvinSimulator.R.layout.fragment_voz, container, false);
       ...
       // ((MainMenuActivity) getActivity()).setActionBarTitle("COMANDOS DE VOZ");
        ...
        // get the listview
        expListView = (ExpandableListView) v.findViewById(ar.com.klee.marvinSimulator.R.id.lvExp);
    ...
    public void dialogCommand(String group, Command command){
        ...
        AlertDialog.Builder builder =new AlertDialog.Builder(getActivity(), ar.com.klee.marvinSimulator.R.style.AppCompatAlertDialogStyle);
