...
public class  CallDriver {
    ...
    public  void outgoingCallDialog(){
        ...
        AlertDialog.Builder builder =new AlertDialog.Builder(commandHandlerManager.getMainActivity(), ar.com.klee.marvinSimulator.R.style.AppCompatAlertDialogStyle);
        ...
        buttonAgenda.setBackgroundResource(ar.com.klee.marvinSimulator.R.mipmap.ic_contact_phone_black_48dp);
