...
public class PerfilFragment extends Fragment {
    ...
    @Bind(ar.com.klee.marvinSimulator.R.id.password_current)  EditText passwordCurrentText;
    @Bind(ar.com.klee.marvinSimulator.R.id.password_new)  EditText passwordNewText;
    @Bind(ar.com.klee.marvinSimulator.R.id.repeat_password) EditText repeatPasswordText;
    @Bind(ar.com.klee.marvinSimulator.R.id.btn_change) Button changeButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(ar.com.klee.marvinSimulator.R.layout.fragment_perfil, container, false);
        ...
        ImageView imageView = (ImageView) view.findViewById(ar.com.klee.marvinSimulator.R.id.im_perfil);
    ...
    private void initializeTwitterSdk() {
        ...
        TwitterLoginButton loginButton = (TwitterLoginButton) view.findViewById(ar.com.klee.marvinSimulator.R.id.twitter_login_button);
    ...
    public void changePassword() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(getActivity(), ar.com.klee.marvinSimulator.R.style.AppTheme_Dark_Dialog);
