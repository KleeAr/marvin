...
public class SignupActivity extends AppCompatActivity {
    ...
    @Bind(ar.com.klee.marvinSimulator.R.id.input_first_name) EditText nameText;
    @Bind(ar.com.klee.marvinSimulator.R.id.input_last_name) EditText lastNameText;
    ...
    @Bind(ar.com.klee.marvinSimulator.R.id.btn_signup) Button signupbutton;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(ar.com.klee.marvinSimulator.R.layout.activity_signup);
        ...
        CheckBox checkBox = (CheckBox)findViewById(ar.com.klee.marvinSimulator.R.id.checkBox);
        TextView tv_terms = (TextView)findViewById(ar.com.klee.marvinSimulator.R.id.tv_terms);
