...
public class EstablecerZoomHandler extends CommandHandler {
    ...
    public EstablecerZoomHandler(TTS textToSpeech, Context context, CommandHandlerManager commandHandlerManager) {
        super(Arrays.asList("establecer zoom {zoom}","setear zoom {zoom}","configurar zoom {zoom}","establecer sub {zoom}","setear sub {zoom}","configurar sub {zoom}"), textToSpeech, context, commandHandlerManager);
    }
